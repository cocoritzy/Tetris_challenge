...
target, perfect_solution = utils.generate_target(width=5, height=5, density=0.5 , forbidden_pieces=the_forbidden_pieces) # NOTE: it is recommended to keep density below 0.8
